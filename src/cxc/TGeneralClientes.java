 ...
 */
public class TGeneralClientes extends javax.swing.JFrame {

    /**
     * Creates new form TablaGeneral_1
     */
    DefaultTableModel dtm=new DefaultTableModel();
    public TGeneralClientes() throws SQLException {
        initComponents();
        this.setLocationRelativeTo(null);
        String[] Titulos=new String []{"NCliente","Nombre","RFC"};
    ...
    */
        ...
        ResultSet rst=stm.executeQuery("SELECT NumCliente, NomCliente, RFC FROM Clientes");
        while(rst.next())
        {
    ...
    private void jDatosMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jDatosMouseClicked
        ...
        {//obtencion mediante un objeto
            ...
            */
            ...
            VistaCliente V1 = null;
            try {
                V1 = new VistaCliente();
            } catch (SQLException ex) {
                Logger.getLogger(TGeneralClientes.class.getName()).log(Level.SEVERE, null, ex);
            }
            V1.setVisible(true);
...
//System.exit(0);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TGeneralClientes.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                try {
                    new TGeneralClientes().setVisible(true);
                } catch (SQLException ex) {
                    Logger.getLogger(TGeneralClientes.class.getName()).log(Level.SEVERE, null, ex);
                }
            }
