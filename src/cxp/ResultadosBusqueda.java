...
public class ResultadosBusqueda extends javax.swing.JFrame {
   ...
   // public String NomProveedor;
    ...
    public ResultadosBusqueda(String usuario) throws SQLException {
        initComponents();
        this.usuario=usuario;
        String[] Titulos=new String []{"NUMERO DE FACTURA","PROVEEDOR","NOMBRE DE PROYECTO","IMPORTE","FECHA INICIO","FECHA FIN","ESTADO"};
        dtm.setColumnIdentifiers(Titulos);
        jDatos.setModel(dtm);
        //ct();
    }
    void ct(String NomProveedor) throws SQLException 
    {

        java.sql.Statement stm=Conexion.getConexion().createStatement();
        ResultSet rst=stm.executeQuery("select NumFactura, NomProveedor, NombreProj,Importe,FEmision,FPago,Anticipo from CXP  where NomProveedor = '"+NomProveedor+"'");
        while(rst.next())
        {
            p=rst.getInt(4);
            dif=rst.getInt(7);
    ...
    private void initComponents() {
        ...
        getContentPane().add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 70, 880, 560));

        pack();
    }// </editor-fold>//GEN-END:initComponents

    private void jbtncloseMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jbtncloseMouseClicked
        MPE MD=new MPE(usuario);
        System.exit(0);
        MD.setVisible(true);
    ...
    private void jDatosMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jDatosMouseClicked
        ...
        {//obtencion mediante un objeto
            ...
            */
            ...
            try {
                Panel_CXP_Busquedas res = new Panel_CXP_Busquedas(usuario); 
                res.setSize(950, 563);
                res.setVisible(true);
                jScrollPane1.removeAll();
                jScrollPane1.add(res, BorderLayout.CENTER);
                jScrollPane1.revalidate();
                jScrollPane1.repaint();
            } catch (SQLException ex) {
                Logger.getLogger(ResultadosBusqueda.class.getName()).log(Level.SEVERE, null, ex);
            }
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                try {
                    new ResultadosBusqueda(usuario).setVisible(true);
