...
public class HG extends javax.swing.JFrame {
    ...
    public HG(String usuario) throws SQLException {
        initComponents();
        this.usuario=usuario;
        this.setLocationRelativeTo(null);
        String[] Titulos=new String []{"NUMERO DE ACCION","USUARIO ","FECHA","HORA","ACCION","MOTIVO","NOM GENERACION"};
    ...
    private void ct() throws SQLException 
    {
        ...
        ResultSet rst=stm.executeQuery("select NUMACCION, NOMUSUARIO, FECHA,HORA,ACCION,MOTIVO,NG from HG");
        while(rst.next())
        {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("ACCIONES GENERADAS EN EL SISTEMA: HISTORICO");
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                try {
                    new HG(usuario).setVisible(true);
                } catch (SQLException ex) {
